...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <section
          className="w-full relative h-screen flex overflow-hidden flex-col
            justify-center gap-6"
        >
          {slidingCards.map((cards, i) => (
            <div
              key={i}
              className="w-full flex-shrink-0 inline-flex flex-nowrap
                overflow-hidden"
            >
          ...
          <div
            className="absolute inset-0 flex justify-center items-center
              ...
              from-transparent from-0% to-background to-90%"
          />
        </section>
        <section className="max-w-4xl mx-auto sticky bottom-0">
          <Card className="border-b-0 rounded-b-none shadow-none">
            ...
            <CardFooter className="flex gap-1">
              ...
              <Button asChild>
                <Link href="/#installation-guide">Install</Link>
              </Button>
            </CardFooter>
          </Card>
        </section>
